        ...
        (select * from
            (select sd.gcsi_user_id, sd.subscription_id, sd.start_date,
             case when sd.start_date > '20150701' and
                  ...
                  then 9
                  when sd.start_date > '20151226' and 
                       fve.series_title in ('Disclosure', 'Wisdom Teachings','Beyond Belief','Open Minds')
                  then 8
             end cohort_id
             from common.subscription_d sd 
...
insert into common.cohort_d (cohort_id, cohort_name, rule_id, rule_name, gcsi_user_id, subscription_id,created)
(select  1,  'Cosmic Disclosure', 1002, 'first video engagement', gcsi_user_id, subscription_id,start_date
 from 
...
insert into common.cohort_d (cohort_id, cohort_name, rule_id, rule_name, gcsi_user_id, subscription_id,created)
(select  9,  'Hidden Origins', 1004, 'first video engagement', gcsi_user_id, subscription_id,start_date
 from 
    (select gcsi_user_id, subscription_id, start_date
     from tmp.fve_series_title
     where cohort_id = 9
...
insert into common.cohort_d (cohort_id, cohort_name, rule_id, rule_name, gcsi_user_id, subscription_id,created)
(select  8,  'Seeking Truth Marathon', 1004, 'first video engagement', gcsi_user_id, subscription_id,start_date
 from 
    (select gcsi_user_id, subscription_id, start_date
     from tmp.fve_series_title
     where cohort_id = 8
...
insert into common.cohort_d (cohort_id, cohort_name, rule_id, rule_name, gcsi_user_id, subscription_id,created)
(select distinct 2,  'Conscious Cleanse', 1005, 'first video engagement', gcsi_user_id, subscription_id,start_date
 from        
     (select gcsi_user_id, subscription_id, start_date
...
insert into common.cohort_d (cohort_id, cohort_name, rule_id, rule_name, gcsi_user_id, subscription_id,created)
(select  3,  'Commit to You', 1006, 'first video engagement', gcsi_user_id, subscription_id,start_date
 from        
     (select gcsi_user_id, subscription_id, start_date
     from tmp.fve_guide_title
     where cohort_id = 3
...
insert into common.cohort_d (cohort_id, cohort_name, rule_id, rule_name, gcsi_user_id, subscription_id,created)
(select  7,  'SG Learn to Meditate', 1007, 'first video engagement', gcsi_user_id, subscription_id,start_date
 from       
     (select gcsi_user_id, subscription_id, start_date
     from tmp.fve_guide_title
     where cohort_id = 7
...
insert into common.cohort_d (cohort_id, cohort_name, rule_id, rule_name, gcsi_user_id, subscription_id,created)
(select  8,  'Balanced You', 1008, 'first video engagement', gcsi_user_id, subscription_id,start_date
 from        
     (select gcsi_user_id, subscription_id, start_date
     from tmp.fve_guide_title
     where cohort_id = 8
