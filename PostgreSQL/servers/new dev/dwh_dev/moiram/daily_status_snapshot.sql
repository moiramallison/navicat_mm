...
CREATE INDEX idx_ptd_sub ON moiram.daily_status_snapshot (subscription_id);
CREATE INDEX idx_ptd_sub_ptdate ON moiram.daily_status_snapshot (subscription_id, paid_through_date);
...
from moiram.user_d ud
join moiram.date_d dd
